# Contributing to Olivia's Beauty Vault

We love your input! We want to make contributing to Olivia's Beauty Vault as easy and transparent as possible, whether it's:
...
## Report bugs using Github's [issue tracker](https://github.com/yourusername/product-catalog/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/yourusername/product-catalog/issues/new); it's that easy!
